...
pdbList = ["2BYG", "MBDLG2HB008", "MBDLG2HB010"]
...
for pdb in pdbList:
    print("../"+pdb+"/base_"+pdb+"_raw_em_step_data.csv")
    mFile = open("../"+pdb+"/base_"+pdb+"_raw_em_step_data.csv", "r")
    mData = csv.reader(mFile)
        
    out = open("../"+pdb+"/base_"+pdb+"_em_metrics.csv","w" ,newline='')
